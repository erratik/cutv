...
class vh_Page_Template_Plugin {
	...
	public static function get_instance() {
		...
		if( null == self::$instance ) {
			self::$instance = new vh_Page_Template_Plugin();
		} // end if
	...
	private function __construct() {
		...
		$this->templates = array(
			'template-submit-video.php'     => __( 'Submit a video', $this->plugin_slug )
		);
	...
	public function view_project_template( $template ) {
		...
		if ( $post != NULL && ! isset( $this->templates[ get_post_meta( $post->ID, '_wp_page_template', true ) ] ) ) {
			return $template;
		} // end if
