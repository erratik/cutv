...
jQuery(document).ready(function() {
	...
	jQuery(".submit_video_button input[name=submit_video]").on('click', function(e) {
		...
		if ( validation && ( ( jQuery('#btn1').length && document.getElementById('btn1').checked === true ) || ( jQuery('#btn3').length && document.getElementById('btn3').checked === true ) || ( jQuery('#btn4').length && document.getElementById('btn4').checked === true ) ) ) {
...
// if ( jQuery('#filepath1').length ) {
// 	jQuery('#filepath1').on( 'change', function() {
// 		jQuery.ajax({
// 			type: 'POST',
// 			url: ajax_login_object.ajaxurl,
// 			data: { action: 'vh_snaptube_video_check', video_url: jQuery(this).val() },
// 			success: function(data) {
// 				console.log(data);
// 			}
// 		});
