<?php
	...
	if( ! function_exists( 'wpvr_render_addons_offers' ) ) {
		function wpvr_render_addons_offers() {
			?>
			<a href = "http://store.wpvideorobot.com/addons/category/bundles/" title = "SAVE 70% RIGHT NOW !">
				<div class = "wpvr_addon_offer">
					<img
						src = "<?php echo WPVR_URL . 'assets/images/offers.gif'; ?>"
						alt = "WPVR ADDONS BUNDLE OFFER"
					/>
				</div>
			</a>
	...
	if( ! function_exists( 'wpvr_addons_licences_form_render' ) ) {
		function wpvr_addons_licences_form_render() {
			...
			<div class = "wpvr_license">
				...
				<form id = "wpvr_register_addons_licences_form" action = "<?php echo WPVR_ACT_URL; ?>">
				...
				<button url = "<?php echo WPVR_ACT_URL; ?>" id = "wpvr_reset_addon_licences" class = "wpvr_black_button pull-left wpvr_submit_button wpvr_large">
