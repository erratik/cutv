<?php
	...
	if ( isset( $_GET[ 'save_options' ] ) ) {
		...
		if ( isset( $_POST[ 'wpvr_options_deferAdding' ] ) ) {
			$new_options[ 'deferAdding' ] = $_POST[ 'wpvr_options_deferAdding' ];
		} else {
			$new_options[ 'deferAdding' ] = "";
		}
	...
	>
		...
		<div class = "">
			<div id = "wpvr_options_wrapper">
				...
				<?php if ( FALSE && get_option( 'dummy_imported' ) != 'yes' ) { ?>
					<button url = "<?php echo WPVR_OPTIONS_URL; ?>" id = "wpvr_get_dummy_data" class = "pull-left wpvr_submit_button wpvr_small">
						<i class = "wpvr_button_icon fa fa-coffee"></i><?php _e( 'Get Dummy data' , WPVR_LANG ); ?>
					</button>
				<?php } ?>
				...
				<div class = "wpvr_option tab_a on">
					<?php
						...
						$isSelected = array();
						foreach ( $wpvr_timezones as $g => $gZone ) {
							foreach ( $gZone as $gValue => $gLabel ) {
								$isSelected[ $gValue ] = '';
							}
						}
						$isSelected[ $wpvr_options[ 'timeZone' ] ] = ' selected="selected" ';
					?>
					<select class = "wpvr_option_select pull-right " name = "wpvr_options_timeZone" id = "wpvr_options_timeZone">
						<?php foreach ( $wpvr_timezones as $g => $gZone ) { ?>
							<optgroup label = "<?php echo $g; ?>">
								<?php foreach ( $gZone as $gValue => $gLabel ) { ?>
									<option
										value = "<?php echo $gValue; ?>"
										<?php echo $isSelected[ $gValue ]; ?>
									>
										<?php echo $gLabel; ?>
									</option>
								<?php } ?>
				...
				<!-- deferAdding -->
				<div class = "wpvr_option tab_a <?php echo wpvr_get_button_state( $wpvr_options[ 'deferAdding' ] ); ?>">
					<div class = "wpvr_option_button pull-right">
				...
				<div class = "wpvr_option tab_f">
					...
					<div class = "option_text">
						...
						<p class = "wpvr_option_desc">
							...
							<?php _e( 'or use the crendentials defined below to connect to Video Services APIs.' , WPVR_LANG ); ?> </p>
					</div>
				</div>
				<!-- /USE ADVANCED CREDENTIALS -->
						...
						<div class = "wpvr_option_inside  first_option tabFix">
							...
							<div>
								...
								<p class = "wpvr_option_desc">
									...
									<a class = "link" target = "_blank" href = "http://support.wpvr.co/tutorials/where-to-find-youtube-api-key/" title = "Click here">
						...
						<div class = "wpvr_option_inside tabFix">
							...
							<div>
								...
								<p class = "wpvr_option_desc">
									...
									<br/><br/>
									<a class = "link" target = "_blank" href = "http://support.wpvr.co/tutorials/where-to-find-vimeo-crendentials" title = "Click here">
						...
						<div class = "wpvr_option_inside tabFix">
							...
							<div>
								...
								<p class = "wpvr_option_desc">
									...
									<br/><br/>
									<a class = "link" target = "_blank" href = "http://support.wpvr.co/tutorials/where-to-find-dailymotion-crendentials/" title = "Click here">
				...
				<div class = "wpvr_option tab_b on">
					...
					<div>
						<span class = "wpvr_option_title"><?php _e( 'Default Wanted Videos' , WPVR_LANG ); ?></span><br/>
				...
				<!-- NoDuplicates -->
				<div class = "wpvr_option tab_b <?php echo wpvr_get_button_state( $wpvr_options[ 'onlyNewVideos' ] ); ?>">
					<div class = "wpvr_option_button pull-right">
				...
				<!-- GetStats -->
				<div class = "wpvr_option tab_b <?php echo wpvr_get_button_state( $wpvr_options[ 'getStats' ] ); ?>">
					<div class = "wpvr_option_button pull-right">
				...
				<!-- GetTags -->
				<div class = "wpvr_option tab_b <?php echo wpvr_get_button_state( $wpvr_options[ 'getTags' ] ); ?>">
					<div class = "wpvr_option_button pull-right">
				...
				<!-- getFullDesc -->
				<div class = "wpvr_option tab_b <?php echo wpvr_get_button_state( $wpvr_options[ 'getFullDesc' ] ); ?>">
					<div class = "wpvr_option_button pull-right">
				...
				<?php if ( FALSE ) { ?>
					<!-- enableContentPrefix *** -->
					<div class = "wpvr_option tab_b <?php echo wpvr_get_button_state( $wpvr_options[ 'enableContentPrefix' ] ); ?>">
						<div class = "wpvr_option_button pull-right">
							<div style = "width:100px;float:right;">
								<?php wpvr_make_switch_button( 'wpvr_options_enableContentPrefix' , $wpvr_options[ 'enableContentPrefix' ] ); ?>
							</div>
							<?php

								if ( $wpvr_options[ 'enableContentPrefix' ] === FALSE ) {
									$hideMe = "display:none;";
								} else {
									$hideMe = "";
								}
							...
							<div class = "wpvr_clearfix"><br/></div>
							<textarea
								class = "wpvr_options_textarea wpvr_large pull-right"
								id = "wpvr_options_contentPrefix"
								name = "wpvr_options_contentPrefix"
								style = "<?php echo $hideMe; ?>"
								placeholder = "Custom HTML that comes before video text content"
							><?php echo $wpvr_options[ 'contentPrefix' ]; ?></textarea>
						</div>
						<div class = "option_text">
							<span class = "wpvr_option_title"><?php _e( 'Enable Video Content Prefix' , WPVR_LANG ); ?></span><br/>

							<p class = "wpvr_option_desc">
								<?php _e( 'Enable this option to automatically add your custom text after the video content.' , WPVR_LANG ); ?>
								<br/>
							</p>
						</div>
						<div class = "wpvr_clearfix"></div>
					...
					<!-- enableContentSuffix *** -->
					<div class = "wpvr_option tab_b <?php echo wpvr_get_button_state( $wpvr_options[ 'enableContentSuffix' ] ); ?>">
						<div class = "wpvr_option_button pull-right">
							<div style = "width:100px;float:right;">
								<?php wpvr_make_switch_button( 'wpvr_options_enableContentSuffix' , $wpvr_options[ 'enableContentSuffix' ] ); ?>
							</div>
							<?php

								if ( $wpvr_options[ 'enableContentSuffix' ] === FALSE ) {
									$hideMe = "display:none;";
								} else {
									$hideMe = "";
								}
							...
							<textarea
								class = "wpvr_options_textarea wpvr_large pull-right"
								id = "wpvr_options_contentSuffix"
								name = "wpvr_options_contentSuffix"
								style = "<?php echo $hideMe; ?>"
								placeholder = "Custom HTML that comes after video text content"
							><?php echo $wpvr_options[ 'contentSuffix' ]; ?></textarea>

						</div>
						<div class = "option_text">
							<span class = "wpvr_option_title"><?php _e( 'Enable Video Content Suffix' , WPVR_LANG ); ?></span><br/>
				...
				<div class = "wpvr_option tab_c <?php echo wpvr_get_button_state( $wpvr_options[ 'autoRunMode' ] ); ?>">
					...
					<div class = "option_text">
						<span class = "wpvr_option_title"><?php _e( 'Enable AutoRun Mode' , WPVR_LANG ); ?></span><br/>

						<p class = "wpvr_option_desc"> <?php _e( 'Disable this option to stop the plugin from working in background.' , WPVR_LANG ); ?> </p>
					</div>
				</div>
				<!-- /Test Mode -->
						...
						<div class = "wpvr_option_desc">
							...
							<div class = "wpvr_cond_div">
								...
								<div class = "wpvr_code_url">
									<strong><?php echo WPVR_CRON_URL . '?token=' . $wpvr_cron_token; ?></strong>
								</div>

								<br/><strong>Crontab line to add ( via URL )</strong>

								<div class = "wpvr_code_url">
									<strong><?php echo ' */10 * * * * wget -q -O /dev/null ' . WPVR_CRON_URL . '?token=' . $wpvr_cron_token; ?></strong>
								</div>
								<br/><strong>Crontab line to add ( via PATH )</strong>

								<div class = "wpvr_code_url">
									<strong><?php echo ' */10 * * * * php -f ' . WPVR_CRON_PATH . ' ' . $wpvr_cron_token; ?></strong>
								</div>


								<br/>
								<a href = "http://support.wpvr.co/how-to-configure-cron-on-wp-video-robot/"> <?php _e( 'Help on Cron Configuring' , WPVR_LANG ); ?> </a> |
								<a href = "http://support.wpvr.co"><?php _e( 'Get Support' , WPVR_LANG ); ?></a>
							</div>
