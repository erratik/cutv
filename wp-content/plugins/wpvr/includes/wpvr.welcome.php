<?php
	...
	$changelog_url = 'http://support.wpvideorobot.com/tutorials/a-preview-of-wp-video-robot-1-8/';
...
<div class = "wrap wpvr_wrap" style = "display:none;">
	...
	<div class = "wpvr_welcome_content">
		<h1 class = "wpvr_welcome_content_title">
			...
			<a class = "version">v<?php echo WPVR_VERSION; ?></a>
		</h1>
				...
				<tr>
					<td class = "wpvr_welcome_content_left ">
						...
						<div class = "wpvr_welcome_content_buttons">
							<br/>
							<a href = "<?php echo $changelog_url; ?>" target = "_blank">
								<button class = "wpvr_button pull-left wpvr_black_button">
									<i class = "fa fa-question-circle"></i>
									<?php echo __( 'What\'s New on that version ?' , WPVR_LANG ); ?>
								</button>
							</a>
							<button
	...
	<span class = "wpvr_welcome_thanks">
		Thank you for using
		<a href = "http://wpvideorobot.com/" target = "_blank">WP Video Robot</a>
		!
	</span>
