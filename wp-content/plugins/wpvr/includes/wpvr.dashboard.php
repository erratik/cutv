								...
								<div class = "wpvr_widget_pie pull-left">
									...
									<script>
										var data_videos_by_service = [
											<?php $i = 0; ?>
											<?php foreach( $video_stats[ 'byService' ][ 'items' ] as $label=>$count){ ?>
								...
								<div class = "wpvr_widget_pie pull-left">
									...
									<script>
										var data_videos_by_cat = [
											...
											<?php foreach( $video_stats[ 'byCat' ][ 'items' ] as $label=>$count){ ?>
								...
								<div class = "wpvr_widget_pie pull-left">
									...
									<script>
										var data_videos_by_author = [
											<?php $i = 0; ?>
											<?php foreach( $video_stats[ 'byAuthor' ][ 'items' ] as $label=>$count){ ?>
									...
									<div class = "wpvr_widget_pie pull-left">
										...
										<script>
											var data_sources_by_services = [
												<?php foreach( $sources_stats[ 'byService' ] as $label=>$count){ ?>
												{
													value: parseInt(<?php echo $count; ?>),
									...
									<div class = "wpvr_widget_pie pull-left">
										...
										<script>
											var data_sources_by_states = [
												<?php foreach( $sources_stats[ 'byState' ] as $label=>$count){ ?>
												{
													value: parseInt(<?php echo $count; ?>),
									...
									<div class = "wpvr_widget_pie pull-left">
										...
										<script>
											var data_sources_by_status = [
												<?php foreach( $sources_stats[ 'byStatus' ] as $label=>$count){ ?>
												{
													value: parseInt(<?php echo $count; ?>),
						...
						<div id = "" class = "postbox ">
							...
							<div class = "inside">
								...
								<?php
									...
									if( $wpvr_options[ 'useCronTab' ] === TRUE ) {
										$cronUsed = '<span class="ok">' . __( 'Real Cron Service' , WPVR_LANG ) . '</span>';
									} else {
										$cronUsed = '<span class="no">' . __( 'Wordpress Cron Service' , WPVR_LANG ) . '</span>';
									}
									
									$cron_file = WPVR_PATH . "/assets/php/cron.txt";
									$cron_data = (array) json_decode( file_get_contents( $cron_file ) );
									...
									$date_a = new Datetime( $cron_data[ 'last_exec' ] , new DateTimeZone( 'UTC' ) );
									$date_a->setTimeZone( new DateTimeZone( $wpvr_options[ 'timeZone' ] ) );
								...
								<div class = "wpvr_automation_status">
									...
									>
										<i class = "wpvr_button_icon fa fa-gears"></i> CONFIGURE AUTOMATION
									</a>
									
									<a
										href = "<?php echo WPVR_CRON_URL . '?debug&token=' . $wpvr_cron_token; ?>"
										target = "_balnk"
										id = "wpvr_trigger_cron"
										class = "pull-right wpvr_submit_button wpvr_small wpvr_trigger_cron wpvr_black_button"
									>
										<i class = "wpvr_button_icon fa fa-paw"></i> MANUALLY TRIGGER CRON
									</a>
