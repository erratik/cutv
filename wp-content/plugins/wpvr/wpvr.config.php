<?php
	...
	define( 'WPVR_MAX_WANTED_VIDEOS' , 50 );
	...
	/* Define button style */
	define( 'WPVR_BUTTON_BGCOLOR' , '#444' );
	define( 'WPVR_BUTTON_COLOR' , '#FFF' );
	
	/* Define button hover style */
	define( 'WPVR_BUTTON_HOVER_BGCOLOR' , '#999' );
	define( 'WPVR_BUTTON_HOVER_COLOR' , '#FFF' );
