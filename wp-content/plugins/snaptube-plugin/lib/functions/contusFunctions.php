		...
		$output .= '<div class="video-socialshare-container">
			...
			<div class="video-socialshare" style="height: auto;">
				<div class="floatleft">
					...
					<a href="http://www.facebook.com/share.php?u=' . urlencode($current_url) . '" onclick="return fbs_click()" target="_blank">
				...
				<div class="floatleft gplusshare">
					<a href="https://plus.google.com/share?url=' . urlencode($current_url) . '" onclick="window.open(\'https://plus.google.com/share?url=' . urlencode($current_url) . '\',null,\'height=626,width=436,status=yes,toolbar=no,menubar=no,location=no\'); return false;" target="_blank">
					...
					if (preg_match ( '/www\.youtube\.com\/watch\?v=[^&]+/', $videourl, $vresult )) {
						...
						$output .= '<iframe id="viddler-' . $viddler_id . '" width="'.$width.'" src="//www.viddler.com/embed/' . $viddler_id . '/?f=1&autoplay=0&player=full&secret=26392356&loop=false&nologo=false&hd=false" frameborder="0" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>';
						 ...
						 if(preg_match ( '/www\.youtube\.com\/watch\?v=[^&]+/', $videourl, $vresult ) ) {
							...
							$output .= '<video widht="100%" id="video" poster="' . $imgurl . '"   src="' . $videourl . '" autobuffer controls>' . $htmlplayer_not_support . '</video>';
						 }
