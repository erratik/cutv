<?php
	...
	/* DEPRECATED */
	if( ! defined( 'WPVR_ACT_URL' ) ) define( 'WPVR_ACT_URL' , WPVR_URL . "includes/wpvr.actions.php" );
	if( ! defined( 'WPVR_UPDATE_URL' ) ) define( 'WPVR_UPDATE_URL' , "http://update.wpvr.co/get.php" );
	if( ! defined( 'WPVR_UPDATE_ZIP_URL' ) ) define( 'WPVR_UPDATE_ZIP_URL' , "http://update.wpvr.co/download.php" );
