    ...
    public function add_newvideo() {
      ...
      if ($this->_addnewVideo) {
        ...
        $videoData = array ( 'name' => $videoName, 'description' => $videoDescription, 'embedcode' => $embedcode, 'file' => $act_filepath, 'file_type' => $video_added_method,
          ...
          'image' => $act_image, 'opimage' => $act_opimage, 'link'  => $videoLinkurl, 'featured' => $videoFeatured, 'download' => $videoDownload, 'post_date' => filter_input ( INPUT_POST, 'post_date' ),
         ...
         */
        //   = filter_input ( INPUT_POST, 'post_date' ) || date ( 'Y-m-d H:i:s' );
        if (!filter_input ( INPUT_POST, 'post_date' )) {
